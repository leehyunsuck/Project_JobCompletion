    ...
    <div class="inner">
        ...
        <form method="post" action="">
            ...
            <div class="col-6 col-12-xsmall">
                <input type="text" name="id" value="" placeholder="이메일" />
            </div>
            <div class="col-6 col-12-xsmall">
                <input type="text" name="password" value="" placeholder="변경할 패스워드" />
            </div>
            <div class="col-6 col-12-xsmall">
                <input type="text" name="check-password" value="" placeholder="변경할 패스워드 확인" />
            </div>
            ...
            <div class="col-12 col-12-xsmall">
                <input type="submit" value="비밀번호 수정" class="primary" />
            </div>
